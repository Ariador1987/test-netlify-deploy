...
const css = {
  code: ".error.svelte-19fmuey{height:100%;display:grid;place-items:center}",
  map: null
};
const Error$1 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$result.css.add(css);
  $$unsubscribe_page();
  return `<div class="error svelte-19fmuey"><h1>${escape($page.status)} : ${escape($page?.error?.message)}</h1>
</div>`;
});
export {
  Error$1 as default
